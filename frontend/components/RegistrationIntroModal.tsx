                ...
                <div className="p-8">
                    ...
                    <div className="space-y-6 mb-8">
                        ...
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">Forbind din konto til Zwift og Strava (begge er påkrævet).</p>
                            </div>
                        </div>
                    ...
                    <div className="mt-8 border-t border-border pt-6">
                        {inAppBrowser ? (
                            <div
                                role="alert"
                                className="rounded-xl border border-amber-300 bg-amber-50 text-amber-900 px-4 py-4 space-y-4"
                            >
                                <div className="text-sm leading-relaxed">
                                    <strong className="block mb-1">Tilmelding virker ikke i Facebook / Messengers browser.</strong>
                                    Tryk på menu-ikonet (
                                ...
                                <button
                                    ...
                                    className="w-full bg-amber-900 text-amber-50 py-3 px-4 rounded-xl font-bold hover:bg-amber-950 transition-colors"
                                >
