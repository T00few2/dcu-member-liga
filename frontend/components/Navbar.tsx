    ...
    <>
                            ...
                            <div className="hidden md:flex items-center gap-6">
                                {navLinks.map(link => (
                                    <Link 
                                        key={link.href} 
                                        href={link.href} 
                                        className={`hover:text-slate-300 text-sm font-medium transition-colors ${
        ...
        {user && isRegistered && (
            <>
                ...
                {/* Drawer Panel */}
                <div 
                    className={`fixed top-0 left-0 h-full w-64 bg-slate-900 text-white z-50 transform transition-transform duration-300 ease-in-out shadow-2xl md:hidden ${
