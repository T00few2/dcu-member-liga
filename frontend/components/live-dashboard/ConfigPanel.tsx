...
export default function ConfigPanel({ config, user, updateConfig }: ConfigPanelProps) {
    return (
        <div className="bg-live-panel p-6 rounded-lg border border-live-border mb-8">
            <h2 className="text-xl font-semibold mb-4 text-live-fg border-b border-live-border pb-2">
                Configuration
            </h2>
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full bg-live-bg border border-live-border rounded px-3 py-2 text-live-fg focus:ring-2 focus:ring-primary outline-none"
                        />
                        <p className="text-xs text-live-muted mt-1">
